...
Java_com_player_binny_ffplayer_util_FFUtils_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_player_binny_ffplayer_util_FFUtils_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_player_binny_ffplayer_util_FFUtils_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_player_binny_ffplayer_util_FFUtils_avFilterInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
Java_com_player_binny_ffplayer_util_FFUtils_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                                 jobject surface) {
